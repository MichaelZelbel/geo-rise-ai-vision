...
const Pricing = () => {
  ...
  const tiers = [{
    ...
    features: [{
      ...
      text: "Weekly analysis updates",
      included: true
    }, {
      text: "Basic visibility score",
      included: true
    }, {
      text: "AI engine breakdown",
      included: true
    }, {
      text: "Competitor names hidden",
      included: false
    }, {
      text: "Limited query coverage (20 queries)",
      included: false
    }, {
      text: "No optimization tips",
      included: false
    }, {
      text: "Basic support",
      included: false
    ...
    features: [{
      text: "3 brands tracked",
      included: true
    }, {
      text: "Daily analysis updates",
      included: true
    }, {
      text: "Full visibility scoring",
      included: true
    }, {
      text: "AI engine breakdown with details",
      included: true
    }, {
      text: "Full competitor visibility (up to 10)",
      included: true
    }, {
      text: "100+ queries per industry",
      included: true
    }, {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-2">Start free, upgrade anytime.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {tiers.map(tier => {
          const isCurrentPlan = currentPlan === tier.planId || currentPlan === "giftedPro" && tier.planId === "pro" || currentPlan === "giftedAgency" && tier.planId === "business";
          return <Card key={tier.name} className={`relative ${tier.highlighted ? "border-primary shadow-2xl scale-105" : tier.planId === "business" ? "border-blue-500/30" : "border-border"}`}>
                {tier.badge && <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {tier.features.map((feature, idx) => <li key={idx} className="flex items-start gap-2">
                        {feature.included ? <Check className="w-5 h-5 text-primary shrink-0 mt-0.5" /> : <X className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />}
                ...
                <CardFooter>
                  <Button className="w-full" variant={tier.planId === "free" ? "outline" : tier.highlighted ? "default" : "secondary"} disabled={isCurrentPlan || checkoutLoading !== null} onClick={() => {
                if (tier.planId === "free") {
                  navigate("/auth");
                } else {
                  handleCheckout(tier.priceId!, tier.planId);
                    ...
                    {checkoutLoading === tier.planId ? "Processing..." : isCurrentPlan ? "Current Plan" : tier.planId === "free" ? user ? "Current Plan" : "Get Started Free" : `Upgrade to ${tier.name}`}
                  </Button>
                </CardFooter>
              </Card>;
        })}
