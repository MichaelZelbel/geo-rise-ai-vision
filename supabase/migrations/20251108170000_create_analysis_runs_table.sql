...
-- Update run_id to reference analysis_runs if it doesn't already
-- Note: We keep run_id as text for compatibility with existing data
-- Add index for faster lookups on run_id
